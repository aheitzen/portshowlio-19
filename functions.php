<?php
/**
 * portshowlio functions and definitions
 *
...
if ( ! function_exists( 'portshowlio_setup' ) ) :
	 ...
	 */
	function portshowlio_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on portshowlio, use a find and replace
		 * to change 'portshowlio' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'portshowlio', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'portshowlio' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'portshowlio_custom_background_args', array(
...
add_action( 'after_setup_theme', 'portshowlio_setup' );
 ...
 */
function portshowlio_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'portshowlio_content_width', 640 );
}
add_action( 'after_setup_theme', 'portshowlio_content_width', 0 );
 ...
 */
function portshowlio_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'portshowlio' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'portshowlio' ),
...
add_action( 'widgets_init', 'portshowlio_widgets_init' );
